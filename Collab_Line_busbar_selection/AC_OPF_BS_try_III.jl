...
gurobi = JuMP.optimizer_with_attributes(Gurobi.Optimizer,"QCPDual" => 1, "time_limit" => 600,"MIPgap" => 1e-4, "BarHomogeneous" => 1,"BarQCPConvTol"=>1e-4)#r, "ScaleFlag"=>2, "NumericFocus"=>2,,"BarQCPConvTol"=>1e-3,) 
...
test_case_file = joinpath(dirname(dirname(input_folder)),"test_cases/case_ACTIVSg500.m")
