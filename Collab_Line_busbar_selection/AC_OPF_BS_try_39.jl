...
scatter(obj_plot,duals_plot,xlabel = "Benefit of busbar splitting compared to OPF [\$]",ylabel = "Duals [\$/MWh]",legend = false,grid = :none,ylims = (-5700,-2000),title = "Splitting one bus per time, case 118")
